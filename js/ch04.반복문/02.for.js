...
console.log(`1에서 100사이 정수의 합 = ${sum100}`);
...
console.log(`1에서 100사이 홀수의 합 = ${sumOdd}`);
...
console.log(`1에서 100사이 짝수의 합 = ${sumEven}`);

// 1에서 100사이의 3의배수 합 구하기
let sumTree = 0;
for (let i = 3; i <= 100; i += 3) {
    sumTree += i;
}
console.log(`1에서 100사이 3의배수 합 = ${sumTree}`);
